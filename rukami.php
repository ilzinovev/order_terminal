<html>
 <head>
  <title>Ручной ввод отдать заказ</title>
       ...
       <div class="container">
         <div class="row">
           ...
           <div class="col-5"><div class="knopki">
              <form action="getContentFromUrl5.php" method="post" name="vform" id="frm">
...
function addNumber(element){
  if((document.getElementById('mvar').value).length>30) {
    document.getElementById('mvar').value = "";
  }
  else {
  document.getElementById('mvar').value = document.getElementById('mvar').value+element.value;}
  if((document.getElementById('mvar').value).length>30) { //ограничение на 6 символов
    document.getElementById('mvar').value = "";
  }
}
